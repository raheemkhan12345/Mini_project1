        ...
        <div className={footerStyles.newsletterSection}>
            <div className={footerStyles.newsletterContent}>
                ...
                <p className={footerStyles.newsletterText}>
                    Subscribe to our newsletter for execlusive offers, new collection announcements, and styling tips.
                </p>
        ...
        <div className={footerStyles.mainGrid}>
            <div className={footerStyles.brandSection}>
                ...
                <p className={footerStyles.brandDescription}>
                    Crafting timeless pieces for the discerning individual. Where pracision meets elegance in every detail.
                </p>
                <div className={footerStyles.socialIconsContainer}>
                    {[Facebook, Instagram, Twitter].map((Icon, index) => (
                        <a href='#' key={index} className={footerStyles.sectionIcon}>
        ...
        <div className={footerStyles.bottomSection}>
            ...
            <div className='flex flex-wrap justify-center gap-2'>
                <p className={footerStyles.designerLink}>
                    ...
                    className={footerStyles.linkHover}>Hexagon Digital Service</a>
                </p>
            </div>
        </div>
      </div>
              <style>
                {footerStyles.mediaQueries}
              </style>
    </footer>
  )
}
